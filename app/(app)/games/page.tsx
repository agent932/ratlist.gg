    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 py-16 sm:py-24">
        ...
        <div className="text-center mb-16">
          ...
          <div className="mt-6 inline-flex items-start gap-3 rounded-lg border border-blue-500/20 bg-blue-500/10 px-4 py-3 text-sm text-blue-300 max-w-2xl mx-auto">
            ...
            <div className="text-left">
              <strong className="font-semibold">Privacy Notice:</strong> For games using EmbarkIDs (e.g., THE FINALS, ARC Raiders), 
              player identifiers containing # symbols will be truncated in public displays to protect privacy. 
              Full identifiers are visible only to the account owner.
            </div>
          </div>
        </div>
