  ...
  return (
    <div className="container py-24 text-center">
      <div className="rounded-lg border border-white/10 bg-white/5 backdrop-blur-sm p-12 max-w-md mx-auto">
        <h1 className="text-2xl font-bold text-white/60 mb-2">Something went wrong</h1>
        <p className="text-white/40 text-sm mb-6">{error.message || 'Failed to load player profile'}</p>
        <button
          onClick={reset}
