          ...
          <footer className="border-t border-white/10 bg-black/50 backdrop-blur-xl py-12">
            <div className="container">
              ...
              <div className="border-t border-white/10 pt-8 space-y-3 text-sm text-white/60">
                <p>
                  Ratlist.gg is a community-run informational site. It is not
                  affiliated with or endorsed by any game studio.
                </p>
                <p>
                  All incidents are user-generated opinions. Use as context, not
                  proof. No harassment, doxxing, or targeted abuse.
                </p>
